...
public class TruckPO extends PageObject {
    ...
    @FindBy(id = "payload")
    private WebElement fieldPayload;
    @FindBy(id = "totalweight")
    private WebElement fieldTotalWeight;
    @FindBy(id = "listprice")
    ...
    public void fillingOutFormVehicleData() {
        ...
        sendKeys(fieldPayload, "300");
        sendKeys(fieldTotalWeight, "25000");
